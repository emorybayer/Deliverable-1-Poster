...
- include only the years 2021 to 2023
- only include the variables 'Year', 'Country of Origin', 'Country of Asylum', 'Rejected Decisions', and 'Total Decisions'.
...
I chose to only include applicants from: 
...
- legal grounds for their asylum applications
- greater ability to access adequate legal services
- applicants eligibility for deportation under a "safe third-party agreement" 
```{r, iristable}
